...
from agentic_workflows.core.llm_integration import (
    call_llm_structured,
)
from agentic_workflows.core.prompt_engine import (
    PromptLoader,
)
from agentic_workflows.models import SegmentationResponse
...
class TestIdentifyTargetNodeWithIDs:
    ...
    def prompt_loader(self):
        ...
        # Get the absolute path to prompts directory (agentic_workflows/prompts/)
        prompts_dir = Path(__file__).parent.parent.parent.parent.parent.parent / "prompts"
