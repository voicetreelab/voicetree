...
import type { Rect, SpatialNodeEntry, SpatialEdgeEntry, SpatialIndex } from '../graphLayoutPrimitives';
import { queryNodesInRect, queryEdgesInRect, createSpatialIndex } from '../graphLayoutPrimitives';
import type { ObstacleBBox } from './findBestPosition';
import { boxObstacle, segmentObstacle } from './findBestPosition';
import type { Obstacle } from './findBestPosition';
import type { EdgeSegment } from '../graphLayoutPrimitives';
