...
export function createSettingsSchema(runtime: SettingsRuntime = {}): SettingsSchema {
    ...
    layoutConfig:           { default: JSON.stringify({ engine: 'cola', kr: 5, kg: 1, ks: 0.1, maxIteration: 0, spacing: 20, nodeSpacing: 120, convergenceThreshold: 0.4, unconstrIter: 15, allConstIter: 25, handleDisconnected: true, edgeLength: 350 }, null, 2), label: 'Layout Config' },
