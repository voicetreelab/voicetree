...
export const OVERRIDABLE_RULE_IDS = ['grandparent_attachment', 'node_line_limit', 'node_must_have_edge', 'subgraph_size_limit', 'child_count_limit', 'folder_child_count_limit', 'graph_complexity_limit'] as const
