...
const DAEMON_ROUTE_IDS = [
  ...
  'session.delete',
  'session.events',
  'session.folder-state.batch',
  'session.folder-state.read',
  'session.folder-state.set',
  'session.show',
  'vault.close',
  'vault.open',
  'vault.set-write-path',
  'vault.show',
  'vault.views.activate',
  'vault.views.clone',
  'vault.views.create',
  'vault.views.delete',
  'vault.views.list',
...
const DAEMON_ROUTE_ID_BY_SIGNATURE = {
  ...
  'DELETE /vault/views/:viewId': 'vault.views.delete',
  'GET /graph': 'graph.read',
  'GET /sessions/:sessionId/folder-state': 'session.folder-state.read',
  ...
  'GET /vault/views': 'vault.views.list',
  'PATCH /sessions/:sessionId/folder-state': 'session.folder-state.batch',
  'PATCH /sessions/:sessionId/folder-state/:encodedPath': 'session.folder-state.set',
  'POST /graph/delta': 'graph.delta',
  'POST /sessions': 'session.create',
  'POST /sessions/:sessionId/selection': 'view.selection',
  'POST /vault/close': 'vault.close',
  'POST /vault/open': 'vault.open',
  'POST /vault/views': 'vault.views.create',
  'POST /vault/views/:viewId/activate': 'vault.views.activate',
  'POST /vault/views/:viewId/clone': 'vault.views.clone',
