...
import { getNextTerminalCountForNode, getExistingAgentNames, recordTerminalPending, clearPendingTerminal } from '@vt/agent-runtime/terminals/terminal-registry/index.ts';
import {
    getRuntimeGraph,
