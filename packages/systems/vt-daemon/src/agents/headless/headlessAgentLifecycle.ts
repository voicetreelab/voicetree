...
import type {SupportedHeadlessCli} from '@vt/agent-runtime/spawn/cli/headlessCli.ts'
...
import type {TerminalRecord} from '@vt/agent-runtime/terminals/terminal-registry/index.ts'
