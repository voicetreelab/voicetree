...
import {getIdleSince as defaultGetIdleSince} from '@vt/agent-runtime/terminals/terminal-registry/queries.ts'
import type {TerminalRecord} from '@vt/agent-runtime/terminals/terminal-registry-state.ts'
