...
import {injectCodexProjectDocDisableFlag} from './injection/codexProjectDocInjection'
...
export async function prepareTerminalDataInMain(
    ...
    // sessions, so suppress Codex's native AGENTS.md project-doc injection to
    // avoid surfacing the same repo instructions twice. No-op for other agents.
