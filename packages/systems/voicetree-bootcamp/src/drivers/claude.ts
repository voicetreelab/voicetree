 ...
 * impure runScenario delegates to runHarnessProcess to spawn `claude`,
 * capture stdout to a transcript file, and fold in driver-measured
 * wall-clock time.
 *
