...
import type { Rect, SpatialNodeEntry, SpatialEdgeEntry, SpatialIndex } from '../spatial';
import { queryNodesInRect, queryEdgesInRect, createSpatialIndex } from '../spatial';
...
import type { EdgeSegment } from '../geometry';
