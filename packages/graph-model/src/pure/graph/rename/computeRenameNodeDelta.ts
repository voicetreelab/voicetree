import type { Graph, GraphDelta, GraphNode, NodeIdAndFilePath, UpsertNodeDelta } from '..'
import * as O from 'fp-ts/lib/Option.js'
import { redirectEdgeTarget } from '../graph-operations/merge/redirectEdgeTarget'
import { getIncomingEdgesToSubgraph } from '../graph-operations/merge/getIncomingEdgesToSubgraph'
...
export function computeRenameNodeDelta(
    ...
    const incomingEdges: readonly { readonly sourceNodeId: NodeIdAndFilePath; readonly edge: import('..').Edge }[] = getIncomingEdgesToSubgraph([oldNodeId], graph)
