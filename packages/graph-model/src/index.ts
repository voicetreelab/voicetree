...
export { getStarredFolders, addStarredFolder, removeStarredFolder } from './watch-folder/starred-folders'
...
export { getUnseenNodesAroundContextNode } from './context-nodes/getUnseenNodesAroundContextNode'
...
// Settings
export { loadSettings, saveSettings } from './settings/settings_IO'
