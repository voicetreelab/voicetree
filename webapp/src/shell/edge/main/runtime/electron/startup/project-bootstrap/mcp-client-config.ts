 ...
 * Existing user projects may still contain a `voicetree` entry inside one of the
 ...
 *
 * `stripStaleVoicetreeMcpEntries` is called once when VoiceTree loads a project.
 * It walks from the project directory up to a boundary ancestor (default: the
