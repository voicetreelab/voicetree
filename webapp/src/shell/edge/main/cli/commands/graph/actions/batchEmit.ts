import {isJsonMode} from '@/shell/edge/main/cli/commands/graph/core/graphCliDependencies'
import {
    formatBatchReportJson,
    formatBatchReportLine,
    formatBatchReportSummary,
    reportExitCode,
} from '@/shell/edge/main/cli/commands/graph/core/schemaGate'
import {setErrorClass, setGateRejection} from '@/shell/edge/main/cli/telemetry/recordCliInvocation'
import type {BatchReport, NodeVerdict} from '@/shell/edge/main/cli/commands/graph/core/types'
