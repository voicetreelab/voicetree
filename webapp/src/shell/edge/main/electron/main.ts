...
import {migrateAgentPromptIfNeeded, migrateLayoutConfigIfNeeded, migrateStarredFoldersIfNeeded} from '@/shell/edge/main/settings/settings_IO';
...
void app.whenReady().then(async () => {
    ...
    // Silently migrate starredFolders from empty array to include ~/voicetree/workflows
