...
import {isTerminalData, isEditorData} from "@/shell/edge/UI-edge/floating-windows/anchoring/types";
...
import { createNodeMenu } from "@/shell/UI/cytoscape-graph-ui/services/menus/createNodeMenu";
