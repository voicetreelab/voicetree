...
import {removeTerminal} from "@/shell/edge/UI-edge/state/stores/TerminalStore";
import {removeEditor} from "@/shell/edge/UI-edge/state/stores/EditorStore";
import {removeImageViewer} from "@/shell/edge/UI-edge/state/stores/ImageViewerStore";
