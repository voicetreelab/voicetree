...
import type { HotkeySettings, HotkeyBinding } from '@vt/graph-model/settings';
import type { Modifier, HotkeyConfig, RegisteredHotkey } from '@/shell/UI/views/graph-view/hotkeyTypes';
import { getHotkeyKey, getHotkeyKeyFromEvent, getModifierFromEvent } from '@/shell/UI/views/graph-view/hotkeyKeyUtils';
import { isInputElement } from '@/shell/UI/views/graph-view/inputElementDetection';
import {
...
} from '@/shell/UI/views/graph-view/graphHotkeyBindings';

// Re-export types for backward compatibility
export type { Modifier, HotkeyConfig } from '@/shell/UI/views/graph-view/hotkeyTypes';
