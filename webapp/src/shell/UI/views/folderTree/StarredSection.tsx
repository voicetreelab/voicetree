...
export function StarredSection({ starredFolders, starredFolderTrees, readPaths, writePath, expandedPaths, onFileSelect, onToggleExpand, onToggleLoad, onSetWriteTarget }: StarredSectionProps): JSX.Element | null {
