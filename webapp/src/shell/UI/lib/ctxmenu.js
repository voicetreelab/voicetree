(function() {
    ...
    function getScale() {
        ...
        return {
            x: body.offsetWidth ? rect.width / body.offsetWidth : 1,
            y: body.offsetHeight ? rect.height / body.offsetHeight : 1
        };
    }
    ...
    /*! ctxMenu v2.0.2 | (c) Nikolaj Kappler | https://github.com/nkappler/ctxmenu/blob/master/LICENSE !*/    var ContextMenu = function() {
