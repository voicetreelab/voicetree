...
import {
  type LayoutQualityBox,
  type LayoutQualityEdge,
  type LayoutQualityNode,
...
export function scoreLayout(
  ...
  const byId = new Map<string, LayoutQualityNode>();
  const boxById = new Map<string, LayoutQualityBox>();
  const boxes: LayoutQualityBox[] = [];
