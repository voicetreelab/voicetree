...
vi.mock('@/shell/edge/UI-edge/graph/actions/handleUIActions', () => ({
...
vi.mock('@/shell/edge/UI-edge/state/stores/EditorStore', () => ({
    getEditorByNodeId: vi.fn(),
}));

vi.mock('@/shell/edge/UI-edge/graph/view/getNodeFromMainToUI', () => ({
