/**
 * BEHAVIORAL SPEC:
 * Tests for VaultPathSelector lazy path expansion via FolderTreeSidebar footer.
 *
...
import { test, setupMockElectronAPIWithNestedFolders } from './vault-selector-test-setup';
