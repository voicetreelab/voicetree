...
// Not exported — callers use the inferred return type of skipIfNoDaemons().
type VtDirectTestCfg = {
...
export function skipIfNoDaemons(): VtDirectTestCfg | null {
...
export async function injectConfig(page: Page, cfg: VtDirectTestCfg): Promise<void> {
