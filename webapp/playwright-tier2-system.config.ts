...
/**
 * Tier 2: focused Electron vault-switch regression coverage.
 *
...
export default defineConfig({
  ...
  testMatch: 'electron-vault-switch.spec.ts',
  fullyParallel: false,
  ...
  reporter: [
    ...
    [CI_CHECK_REPORTER, {
      checkId: 'e2e-tier2',
      checkName: 'E2E Tier 2 (Electron Vault Switch)',
