...
# Directory Settings
OUTPUT_DIR = "backend/oldVaults/VoiceTreePOC/QualityTest"
BACKUP_DIR_BASE = "backend/oldVaults/VoiceTreePOC/OLDQualityTest"
...
DEFAULT_TEST_TRANSCRIPTS = [
    {
        "file": "backend/oldVaults/VoiceTreePOC/og_vt_transcript.txt",
