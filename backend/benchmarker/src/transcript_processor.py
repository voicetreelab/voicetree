...
class TranscriptProcessor:
    ...
    def __init__(self) -> None:
        self.decision_tree: Optional[MarkdownTree] = None
        self.processor: Optional[ChunkProcessor] = None

    def _initialize_processor(self, transcript_file: str, output_subdirectory: Optional[str] = None) -> str:
    ...
    def _limit_content_by_words(self, content: str, max_words: Optional[int]) -> str:
    ...
    async def process_content(
        ...
        try:
            ...
            if self.processor is not None:
                ...
                print("Completed. No processor statistics available.")
