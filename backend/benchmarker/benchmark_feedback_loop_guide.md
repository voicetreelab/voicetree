...
This guide explains how to systematically test, debug, and continuously improve the VoiceTree agentic workflow system through automated quality assessment. The system processes voice transcripts through a 4-stage pipeline to build  trees which represent the spoken content, and this guide provides both manual analysis techniques and automated scoring frameworks for building a self-improving system.
...
├── STAGE 4 (TODO OLD  node extraction HAS BEEN REMOVED): Was this content properly extracted?
...
3. **TODO OLD  node extraction HAS BEEN REMOVED:** Ensure meaningful, specific node names are generated
...
**Stage 4 Analysis (TODO OLD  node extraction HAS BEEN REMOVED):**
```bash
...
**TODO OLD  node extraction HAS BEEN REMOVED Issues → Semantic Naming:**
...
**Root Cause:** Weak segmentation or poor TODO OLD  node extraction HAS BEEN REMOVED
**Where to look:**
- `segmentation_debug.txt` - check chunk naming quality
- `node_extraction_debug.txt` - check final name extraction
**Solution:** Improve segmentation prompt or TODO OLD  node extraction HAS BEEN REMOVED logic
...
2. **TODO OLD  node extraction HAS BEEN REMOVED:** Check `node_extraction_debug.txt` - was this topic identified for extraction?
...
### For Better TODO OLD  node extraction HAS BEEN REMOVED
...
#### **Stage 4: TODO OLD  node extraction HAS BEEN REMOVED Quality Score (0-100)**
