"""
Test suite for AppendToRelevantNodeAgent Cloud Function with real LLM calls

Tests the HTTP Cloud Function version of the agent.
"""
...
class TestAppendToRelevantNodeAgentCloudFunction:

    @pytest.fixture
    def agent(self):
        """Create HTTP client for AppendToRelevantNodeAgent Cloud Function"""
        return AppendToRelevantNodeAgentHTTPClient(base_url="http://localhost:8080")
