#!/usr/bin/env python3
"""
Test the VoiceTree LangGraph pipeline with real examples using Cloud Function
"""
...
async def test_complex_tree_creation():
    """Test with the same examples used in the integration tests - using Cloud Function"""

    print("🧪 Testing VoiceTree LangGraph Pipeline with Cloud Function")
    print("=" * 80)
...
async def test_single_transcript():
    """Test with a single transcript for quick testing - using Cloud Function"""

    print("\n🧪 Quick Test with Single Transcript (Cloud Function)")
    print("=" * 80)
