...
**Important:** TextToTreeServer is NOT responsible for reading existing markdown files. File watching and graph visualization of existing markdown files happens independently via `FileWatchManager` and the frontend renderer.
