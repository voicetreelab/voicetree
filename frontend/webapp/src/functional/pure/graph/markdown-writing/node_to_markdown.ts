import type {GraphNode, NodeUIMetadata} from "@/functional/pure/graph/types.ts";
import * as O from 'fp-ts/lib/Option.js'
import matter from 'gray-matter'
import type {Frontmatter} from '@/functional/pure/graph/markdown-parsing/extract-frontmatter.ts'
