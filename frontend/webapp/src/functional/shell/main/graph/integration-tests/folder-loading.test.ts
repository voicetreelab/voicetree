...
import { getGraph, setGraph, setVaultPath } from '@/functional/shell/main/state/graph-store.ts'
...
describe('Folder Loading - Integration Tests', () => {
  ...
  describe('BEHAVIOR: Load and switch between directories', () => {
    ...
    it('should detect file addition and deletion after folder is loaded', async () => {
      ...
      const { handleFSEventWithStateAndUISides } = await import('@/functional/shell/main/graph/readAndDBEventsPath/handleFSEventWithStateAndUISides.ts')
