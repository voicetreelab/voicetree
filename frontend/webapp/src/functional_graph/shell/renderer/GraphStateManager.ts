// import { projectToCytoscape } from './markdown_parsing/project-to-cytoscape.ts'
// import type { Graph, CytoscapeElements } from './types'
// import type { Core as CytoscapeCore } from 'cytoscape'
//
/**

 * TODO, I DO NOT LIKE THIS CLASS, IT SHOULD PROBABLY BE REMOVED, THERE MUST BE A BETTER FUNCTIONAL PATTERN HERE
 ...
 * - This class does NOT mutate pure state
 */
