 ...
 * a simple UI-edge for recording and text input.
 *
 * Usage:
 * ```typescript
...
export class VoiceInputView extends Disposable {
   ...
   *
   * @param container HTMLElement to render UI-edge into
   */
  ...
  /**
   * Update record button UI-edge based on state
   */
